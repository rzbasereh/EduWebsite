                    ...
                    if (data.value === "success") {
                        ...
                        for (let i in questions) {
                            let SelectedQuestions = "<div class=\"questions\">\n" +
                                ...
                                // "                <img src=\"../../../main/static/main/img/kanoon.png\">\n" +
                                "                                                    <p>98-99</p>\n" +
                                "                                                </div>\n" +
                                "                                            </div>\n" +
                                ...
                                "                                                <span>1) " +
                                questions[i]["fields"]["choice_1"] +
                                "</span>\n" +
                                "                                                <span class=\"selected-correct-choice\"><span\n" +
                                "                                                        class=\"inline-selected-correct-choice-tick\"></span>2) " +
                                questions[i]["fields"]["choice_2"] +
                                "</span>\n" +
                                "                                                <span>3) " +
                                questions[i]["fields"]["choice_3"] +
                                "</span>\n" +
                                "                                                <span>4) " +
                                questions[i]["fields"]["choice_4"] +
                                "</span>\n" +
                                "                                            </div>\n" +
